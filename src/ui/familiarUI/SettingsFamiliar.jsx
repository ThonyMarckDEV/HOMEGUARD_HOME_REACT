...
const Settings = () => {
  ...
  const uploadProfileImage = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/api/uploadProfileImageUsuarioFamiliar/${idUsuario}`, {
        method: 'POST',
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  const updateUserData = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/api/updateUsuarioFamiliar/${idUsuario}`, {
        method: 'PUT',
        headers: {
          Authorization: `Bearer ${token}`,
